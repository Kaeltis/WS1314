...
public class Bruch implements Cloneable {
    ...
    public Bruch potenziere(long potenz) {
        ...
        Bruch tempBruch = (Bruch) this.clone();
        ...
        long zaehler = (long) Math.pow(tempBruch.zaehler, potenz);
        long nenner = (long) Math.pow(tempBruch.nenner, potenz);

        Bruch newBruch = new Bruch(zaehler, nenner);

        if (warEcht) {
            newBruch = newBruch.echterBruch();
        }
    ...
    private Bruch rechenOperation(Bruch zweiterBruch, char operation) {
        ...
        if (this.isEcht() || zweiterBruch.isEcht()) {
            echt = true;
        }
